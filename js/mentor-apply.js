(function () {
  ...
  const STYLE = `
    ...
    .afield input,.afield textarea{width:100%;padding:11px 14px;border:1.5px solid #E0E4F0;border-radius:10px;font-family:'Poppins',sans-serif;font-size:14px;color:#111114;background:#fff;transition:.2s;outline:none}
