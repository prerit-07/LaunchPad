...
const SAMPLE_DATA = {
  ...
  materials: [
    ...
    { ProgramCode:'PB-MASTER', Category:'Case Prep',     Type:'ppt',   Name:'Winning Case PPTs (30+)',     Meta:'AIR 1 Mentor Collection',         Link:'https://drive.google.com/drive/folders/1Ir9BWGjYgYsLJwneq9WoTI6dbDezXS_H' },
    { ProgramCode:'PB-MASTER', Category:'CV & Resume',   Type:'pdf',   Name:'Sample CVs — Finance & Strategy',Meta:'IIM / XLRI / FMS Placements',  Link:'https://drive.google.com/drive/folders/18bj7C4I4Ro1DcOBfzF6xrEhNI7SmEZe2' },
    ...
    { ProgramCode:'BUNDLE',    Category:'Case Prep',     Type:'ppt',   Name:'Winning Case PPTs (30+)',     Meta:'AIR 1 Mentor Collection',         Link:'https://drive.google.com/drive/folders/1Ir9BWGjYgYsLJwneq9WoTI6dbDezXS_H' },
